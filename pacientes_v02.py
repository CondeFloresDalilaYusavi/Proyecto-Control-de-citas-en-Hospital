...
def mostrar_datos_paciente():
    ...
    tk.Label(area_dinamica, text="Cama:").pack()
    cama_paciente = tk.Entry(area_dinamica)
    cama_paciente.pack(pady=5)
...
def mostrar_areas():
    ...
    tk.Radiobutton(area_dinamica, text="Urgencias", variable=opcion_elegidaA, value="Urgencias").pack()
    tk.Radiobutton(area_dinamica, text="Hospitalización", variable=opcion_elegidaA, value="Hospitalización").pack()
    tk.Radiobutton(area_dinamica, text="Unidad de cuidados intensivos", variable=opcion_elegidaA, value="Unidad de cuidados intensivos").pack()
...
def mostrar_camas():
    ...
    tk.Label(area_dinamica, text="Selección Numero de cama:").pack()
